...
class Test(object):
    ...
    def GenerateIniFile(self):
        ...
        fileStr += '\n'
        fileStr += '[AdjustedCubeMap]\n'
        fileStr += 'type=AdjustedCubeMap\n'
        fileStr += '\n'
        fileStr += '[EquiAngularCubeMap]\n'
        fileStr += 'type=EquiAngularCubeMap\n'
        fileStr += '\n'
        fileStr += '[Equalarea]\n'
        fileStr += 'type=Equalarea\n'
        fileStr += '\n'
        fileStr += '[SegmentedSphere]\n'
        fileStr += 'type=SegmentedSphere\n'
        fileStr += '\n'
        fileStr += '[LogWriter]\n'
